    ...
    <s:iterator value="list" var="article">
        <ul class="list_goods_ul">
            ...
            <li>
                ...
                <img class="img_icon" src="${ctx }/images/edit_icon.png" alt="修改"></a>
            </li>
            <li>
                <a href="${ctx}/article_delete.action?article_id=<s:property value="#article.article_id"/>">
                    <img class="img_icon" src="${ctx }/images/delete_icon.png" alt="删除">
                </a>
            </li>
        </ul>
    </s:iterator>
...
<script>
    ...
    $("#page").paging({
        ...
        callback: function(num) {
           ...
           $(window).attr('location','${ctx}/article_pageList.action?currPage='+num+'&keyWord='+keyWord);
        }
    });
    ...
    $("#input_search_btn").click(function () {
        var keyWord=$("#input_search").val();
        $(window).attr('location','${ctx}/article_pageList.action?keyWord='+keyWord);
    });
</script>
